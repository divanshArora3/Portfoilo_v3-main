  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "divansharora03@gmail.com",
      link: "mailto:divansharora03@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Jalandhar, Punjab, India",
      link: "https://maps.google.com/?q=Jalandhar",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/divanshArora3",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/divansh-arora-dk30",
    },
    {
      icon: <Twitter className="h-5 w-5" />,
      name: "Twitter",
      url: "https://twitter.com/_divansharora_",
    },
  ];
