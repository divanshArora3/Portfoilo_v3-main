...
const SkillsSection = () => {
  ...
  const skills = [
    ...
    { name: "C/C++-Programming", category: "DSA", color: "#276DC3", bgColor: "bg-blue-600/20" },
  ...
  const categories = ["All","Frontend", "DSA","AI/ML", "Backend", "Databases", "Tools"];
  ...
  const filteredSkills = activeFilter === "All" 
    ...
    : skills.filter(skill => {
        ...
        if (activeFilter === "DSA") return skill.category === "DSA" || skill.category === "Language";
  ...
  const getSkillIcon = (name: string) => {
    const iconMap: { [key: string]: string } = {
      ...
      "C/C++ -Programming": "devicon-r-original",
