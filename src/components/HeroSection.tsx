      ...
      <div className="container mx-auto px-4 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Passionate about programming and software development with expertise in C, C++ , JavaScript, and Python.
              Building modern web applications using Node.js, React.js, Express.js and MongoDb. Freelancer specializing in AI-powered solutions.
            </motion.p>
