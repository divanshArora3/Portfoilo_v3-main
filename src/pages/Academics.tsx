  ...
  const education = [
    {
      ...
      cgpa: "8.0",
      details: [
        "Pursuing a B.Tech in Instrumentation and Control Engineering",
        "Key courses include Data Structures, Algorithms, Computer Networks, Machine Learning",
        "Actively participating in competetive programming contests on LeetCode and CodeChef",
      ]
    },
    {
      id: 2,
      ...
      details: [
        ...
        "Highlights: Advanced Mathematics and Physics coursework",
  ...
  const certifications = [
    {
      ...
      issuer: "Coursera",
      date: "2023",
      description: "Comprehensive course covering advanced C and C++ concepts and applications."
    },
    {
      id: 2,
